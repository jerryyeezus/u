...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.cap_array, android.R.layout.simple_spinner_item);
		...
		protected String doInBackground(String... arg0) {
		    try {
				...
				if(rcvMessage.getRequest().equals("list")) {
					return rcvMessage.getFilenames().length + " files on server: \n\n" + rcvMessage.getFileNameString();
				}
	                ...
	                Message sndMessage = new Message("pull", diffNames, rcvMessage.getCksums());
	                ...
	                Message sndMessage = new Message("pull", capNames, rcvMessage.getCksums());
	                encodedMessage = Message.encodeMessage(sndMessage);
	                out.println(encodedMessage);
	                String musicDir = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_MUSIC).toString();
